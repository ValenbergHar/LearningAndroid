...
public class MainActivity extends AppCompatActivity {
    ...
    private List<King> kingsList = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fillKingsList();
        //Log.d(TAG, "onCreate" + kingsList.toString());
    ...
    private void fillKingsList() {
        ...
        King p5 = new King(5, "Тройдзень", 1269, "https://ru.wikipedia.org/wiki/Тройден#/media/Файл:Lithuanian_Grand_Duke_Traidenis.JPG");
        ...
        King p10 = new King(10, "Гыдымін (Гедзімін)", 1316, "https://upload.wikimedia.org/wikipedia/commons/thumb/4/4f/Gedimin_grav_xvii.jpg/274px-Gedimin_grav_xvii.jpg");
