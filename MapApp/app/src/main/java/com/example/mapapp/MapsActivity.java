            ...
            public void onComplete(@NonNull Task<Location> task) {
                ...
                if(location!=null){
                    try {
                        ...
                        textView7.setText(Html.fromHtml("<font color='#6200EE'><b>Рэгіён :</b><br></font>"+addresses.get(0).getAdminArea()));
...
//        textView.setText(String.valueOf(location.getLongitude()) + " " + String.valueOf(location.getLatitude()));
//        textView.setText("Lat - " + String.valueOf(lastLocation.getLatitude()) + ", Ltn - " + String.valueOf(lastLocation.getLongitude()));
    }
