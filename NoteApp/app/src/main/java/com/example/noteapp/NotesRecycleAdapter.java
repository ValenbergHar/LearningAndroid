...
public class NotesRecycleAdapter extends FirestoreRecyclerAdapter<Note, NotesRecycleAdapter.NoteViewHolder> {
    NoteListener noteListener;
    private static final String TAG = "NotesRecycleAdapter";

    public NotesRecycleAdapter(@NonNull FirestoreRecyclerOptions<Note> options, NoteListener noteListener) {
        super(options);
                ...
                public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                    if (noteListener != null) {
                        ...
                        if (note.getCompleted() != isChecked) {
                            noteListener.handlerCheckChanged(isChecked, snapshot);
                        }
                    }
                }
            });
