...
public class KingFull implements Serializable {
    private String id;
    ...
    public KingFull(String id, String kingName, String kingDateLife, String kingDateReign, String kingShortHist, String kingLongHist, List<String> kingPhotos, List<String> kingPhotosDesc) {
        this.id = id;
